...
def hole_af(file1,file2,chord,r,xloc):
    ...
    height = math.abs(ypoints(index) - ypoints(index-half))
...
chord = input("Enter chord of new airfoil")
r = input("Enter radius of circular hole desired")
xloc = input("Enter the xloc of the hole (from 0 to 1")
